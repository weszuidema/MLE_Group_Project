...
xhyp <- cfMake(model_d, mi_data[[1]], nscen=13)
...
xhyp <- cfName(xhyp, "Indonesia", scen=11)
xhyp <- cfChange(xhyp, "australia", x=0, scen=11)
xhyp <- cfChange(xhyp, "hungary", x=0, scen=11)

xhyp <- cfName(xhyp, "Australia", scen=12)
xhyp <- cfChange(xhyp, "australia", x=1, scen=12)
xhyp <- cfChange(xhyp, "hungary", x=0, scen=12)

xhyp <- cfName(xhyp, "Hungary", scen=13)
xhyp <- cfChange(xhyp, "australia", x=0, scen=13)
xhyp <- cfChange(xhyp, "hungary", x=1, scen=13)
...
tile(trace1,
     ...
     topaxis=list(add=TRUE, at=c(0, .1, .2, .3, .4, .5)),
     ...
     output = list(file="figures/MIexpected_values_cfe")
)
...
tile(trace2,
     ...
     width=list(spacer=3),
     height = list(plottitle=3,xaxistitle=3.5,topaxistitle=3.5),
     output=list(file="figures/MIfirstdifferences_cfe")
)
